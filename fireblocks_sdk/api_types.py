...
TRANSACTION_TYPES = (TRANSACTION_TRANSFER, TRANSACTION_MINT, TRANSACTION_SUPPLY_TO_COMPOUND, TRANSACTION_REDEEM_FROM_COMPOUND)
...
TRANSACTION_STATUS_PENDING_COMPLETED = "PENDING_COMPLETED"
...
TRANSACTION_STATUS_PENDING_COMPLETED,
