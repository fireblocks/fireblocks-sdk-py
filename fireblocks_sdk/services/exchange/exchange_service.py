...
class ExchangeService(BaseService):
    ...
    @response_deserializer(ExchangeResponse)
    def get_exchange_account(self, exchange_account_id: str) -> ExchangeResponse:
    ...
    @response_deserializer(ExchangeResponse)
    def get_exchange_account_asset(self, exchange_account_id: str, asset_id: str) -> ExchangeResponse:
